...
for file in files:
    file_path = f"C:/Users/Shin/Documents/Final_Project/Data/교육_전국/교원당학생수/연도별_교원당학생수_{file}.xlsx"
...
# 연도별 데이터 저장
output_base_path = "C:/Users/Shin/Documents/Final_Project/Data/교육_전국/교원당학생수/"

for year in range(2015, 2022):
    year_str = str(year)
    output_file_path = f"{output_base_path}/교원당_{year}_전국.xlsx"
