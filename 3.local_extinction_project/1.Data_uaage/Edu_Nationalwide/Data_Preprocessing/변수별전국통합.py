...
for year in range(2015, 2022):
   ...
   # data['By administrative district (Dong-eup-myeon)'] = data['By administrative district (Dong-eup-myeon)'].apply(lambda x: add_year_suffix(x, start_year, end_year))
            
    annual_data[year_str] = data
    
    # DATUM = Data.ILOC[:,0].Apply(Lamma x: F"시_{x}")
